...
pub fn clean_pdf(data: Vec<u8>, force_naive: bool) -> (Vec<u8>, u8) {
    ...
    try_clean_pdf(data, force_naive).expect("Unable to clean PDF")
}

/// Fallible entry point used by the app's command-line engine.
pub fn try_clean_pdf(data: Vec<u8>, force_naive: bool) -> Result<(Vec<u8>, u8), String> {

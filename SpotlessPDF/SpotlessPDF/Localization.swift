...
enum L10n {
    static var removePDF: String { AppLocalization.localized("button.remove_pdf") }
    static var dropPrompt: String { AppLocalization.localized("workspace.drop") }
    static var saveTo: String { AppLocalization.localized("workspace.save_to") }
    static var readyToClean: String { AppLocalization.localized("workspace.ready") }
    static var cleaning: String { AppLocalization.localized("workspace.cleaning") }
    static var cleaningComplete: String { AppLocalization.localized("workspace.complete") }
    static var showInFinder: String { AppLocalization.localized("workspace.reveal") }
    static var loadAnother: String { AppLocalization.localized("workspace.another") }
    static func pageCount(_ count: Int) -> String {
        String(format: AppLocalization.localized(count == 1 ? "workspace.page" : "workspace.pages"), locale: AppLocalization.locale, count)
    }
